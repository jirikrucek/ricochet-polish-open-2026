...
1. Add translation keys to **ALL 5 language files**: [en.json](../src/i18n/en.json), [pl.json](../src/i18n/pl.json), [nl.json](../src/i18n/nl.json), [de.json](../src/i18n/de.json), [cs.json](../src/i18n/cs.json)
